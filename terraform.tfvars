parameters = {
  ...
  "docdb.dev.endpoint"          = { type = "String", value = "dev-docdb-cluster.cluster-c18g0kw0etra.us-east-1.docdb.amazonaws.com" }
  "rds.dev.master_username"     = { type = "String", value = "devadmin" }
  "rds.dev.database_name"       = { type = "String", value = "dummy" }
  "user.dev.REDIS_HOST"         = { type = "String", value = "dev-redis-elasticache-cluster.liri7p.0001.use1.cache.amazonaws.com" }
  "cart.dev.REDIS_HOST"         = { type = "String", value = "dev-redis-elasticache-cluster.liri7p.0001.use1.cache.amazonaws.com" }
  "cart.dev.CATALOGUE_HOST"     = { type = "String", value = "catalogue-dev.prashdevops.online" }
  "cart.dev.CATALOGUE_PORT"     = { type = "String", value = "80" }
  "shipping.dev.CART_ENDPOINT"  = { type = "String", value = "cart-dev.prashdevops.online:80" }
  "shipping.dev.DB_HOST"        = { type = "String", value = "dev-mysql-rds-cluster.cluster-c18g0kw0etra.us-east-1.rds.amazonaws.com" }

  "payment.dev.CART_HOST"  = { type = "String", value = "cart-dev.prashdevops.online" }
  "payment.dev.CART_PORT"  = { type = "String", value = "80" }
  "payment.dev.USER_HOST"  = { type = "String", value = "user-dev.prashdevops.online" }
  "payment.dev.USER_PORT"  = { type = "String", value = "80" }
  "payment.dev.AMQP_HOST"  = { type = "String", value = "rabbitmq-dev.prashdevops.online" }
  ...
  "cart.prod.CATALOGUE_HOST"    = { type = "String", value = "catalogue-prod.rdevopsb72.online" }
  "cart.prod.CATALOGUE_PORT"    = { type = "String", value = "80" }
  "shipping.prod.CART_ENDPOINT" = { type = "String", value = "cart-prod.rdevopsb72.online:80" }
  "shipping.prod.DB_HOST"       = { type = "String", value = "prod-mysql-rds-cluster.cluster-cmscnppwjzuf.us-east-1.rds.amazonaws.com" }
  "catalogue.prod.MONGO_URL"    = { type = "SecureString", value = "mongodb://docdbadmin:roboshop1234@prod-docdb-cluster.cluster-cmscnppwjzuf.us-east-1.docdb.amazonaws.com:27017/users?tls=true&replicaSet=rs0&readPreference=secondaryPreferred&retryWrites=false"}
  ...
  ## ElasticSearch
  "elasticsearch.username" = { type = "String", value = "elastic" }
  "elasticsearch.password" = { type = "SecureString", value = "IE_jRn*H5wKGW*q12UAC" }   #Change the ELK Password
